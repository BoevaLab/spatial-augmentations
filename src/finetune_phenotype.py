...
------
Train on CPU:
>>> python src/finetune_phenotype.py trainer=cpu
Train on GPU:
>>> python src/finetune_phenotype.py trainer=gpu
Train on MacOS with MPS:
>>> python src/finetune_phenotype.py trainer=mps
Train on multiple GPUs:
>>> python src/finetune_phenotype.py trainer=gpu trainer.devices=2
Train model with chosen experiment configuration from configs/experiment/:
>>> python src/finetune_phenotype.py experiment=experiment_name.yaml
You can override any parameter from command line like this:
>>> python src/finetune_phenotype.py trainer.max_epochs=20 data.batch_size=64

Functions:
----------
- finetune: Handles the core training and testing logic.
...
@hydra.main(version_base="1.3", config_path="../configs", config_name="finetune_domain.yaml")
